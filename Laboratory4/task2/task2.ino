/*
Short Melody of Maha Chulalongkorn Song
*/
...
const int note[] = {D*2, C*2, D*2, F, C*2, A, A, A};            //define note as an array of integers
const int noteDuration[] = {8, 8, 8, 8, 8, 8, 8, 1};        //define noteDuration as an array of integers
const int noteDelay[] = {50, 50, 50, 50, 50, 50, 0, 50}    //define noteDelay as an array of integers
void setup() {
